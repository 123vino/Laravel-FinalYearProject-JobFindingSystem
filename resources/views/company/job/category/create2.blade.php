    ...
    <div class="row justify-content-center">
	    <div class="col-md-8"> 
		   <div class="card card-default">  
                <div class="card-header" style="background-color: rgb(152, 99, 123)"><h3 class="h3 text-center text-info">Create Job for Engineering</h3></div>
                    ...
                    {{--   <div class="form-group">
					  ...
					  <div class="row">
                        <div class="form-group col-md-6">
						    <label for="addrress">Location</label>
