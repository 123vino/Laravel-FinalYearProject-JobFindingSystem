...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color: gray"><h4><b>{{ __('Job Finder Registration') }}</b></h4></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="mobileNo" class="col-md-4 col-form-label text-md-end">{{ __('Contact Number') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="mobileNo" class="form-control @error('email') is-invalid @enderror" name ="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <br>
                        <div class="row mb-3">
                            <p class="mb-0">Already have an account?Please click here for <a href="{{ route('login') }}" class="text-black-50 fw-bold">Login</a></p>
                        </div>
                    </form>
                </div>
            </div>
