...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
                ...
                <div class="card-header">{{ ('Hai') }} {{ Auth::user()->firstName}}{{ __('! You are logged in as Job Finder.') }}</div>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-black navbar-black">
    ...
    <h5 class="m-0">Hai {{Auth::user()->firstName }}! Welcome To J.O.B</h5>
    <!-- Left navbar links -->
   {{--  <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Job Finder Dashboard</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('jobrecent', Auth::user()->id)}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
               Recent Jobs
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('myjobs.user', Auth::user()->id)}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
               My Jobs
              </p>
          ...
          <div class="row justify-content">
              ...
              <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="{{ route('jobprofile2',$post->id) }}" class="btn btn-primary">View Job</a>
                  </div>
                </div>
                &nbsp;&nbsp;
                @endforeach
